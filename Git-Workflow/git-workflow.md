...
1. upstream: the repo from someone else.比如说组里面的库，比如说master。
2. origin: 你自己fork出来的repo.
3. local repo: 本地计算机。
...
```
# git remote add custom-repo-name repo-ssh-url
$ git remote add upstream url
```
upstream是自定义的名字，后面的url是组里面的远程repo.
